...
var Svg = function (_Component) {
  ...
  function Svg(props) {
    ...
    _this.initializeRects = function (table) {
      ...
      table.forEach(function (item) {
        _svg2.default.get(item.id).attr({
    ...
    _this.grow = function () {
      var rect = _svg2.default.get("Rect1");
    ...
    _this.toMobile = function () {
      var el = _svg2.default.get("g6521");
  ...
  Svg.prototype.componentDidMount = function componentDidMount() {
    var container = _svg2.default.get("svg2");
    ...
    _svg2.default.get("wheel2").animate(2000).rotate(360).loop();
    _svg2.default.get("wheel3").animate(2000).rotate(-360).loop();
    _svg2.default.get("wheel1").animate(4000).rotate(-360).loop();

    _svg2.default.get("app1").attr({
      "fill-opacity": 0
