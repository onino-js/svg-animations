...
class Svg extends Component {
  ...
  componentDidMount() {
    const container = SVG.get("svg2");
    let path = container.path("M150 0 L75 200 L225 200 Z");
    path.attr({ fill: "#FFF333" });
    path
      .animate()
      .plot(
        "m43.69 56.37c17.81-45.27 53.96-0.49 82.31 29.29-124.1 50.24-125.7-55-82.31-29.29",
      );
    ...
    const opts2 = [
      buildRect("Rect1", 111.1 * 4, 500, "#ff6600"),
      buildRect("Rect5", 111.1 * 4, 500, "#003380"),
      buildRect("Rect3", 111.1 * 4, 500, "#00d455"),
      buildRect("Rect6", 111.1 * 4, 500, "#ffcc00"),
      buildRect("Rect2", 111.1 * 4, 500, "#ff0000"),
      buildRect("Rect4", 111.1 * 4, 500, "#00aa88"),
    ];
